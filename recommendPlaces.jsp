...
<html lang="en">
 ...
 <table class="table table-bordered table-striped" >
		<thead>
			...
			<tr>
				<th bgcolor="#ddd">Places</th>
				>
			</tr>
		</thead>
		
		<% 
		ArrayList<String> recommendPlace = (ArrayList<String>) session.getAttribute("recommend");
		

		 Iterator itr = recommendPlace.iterator(); 
		 int count=0;
          while (itr.hasNext()) { 
        	  String recommendation=(String)itr.next();
        	  System.out.println("recommendation:-"+recommendation);
          //s  Map.Entry mapElement = (Map.Entry)hmIterator.next(); 
		...
		<td bgcolor="#eee"><%=recommendation%></td>
