...
<html lang="en">
  ...
  <br><br><br>
  <h3>Recommended Shopping Street</h3>
 <table class="table table-bordered table-striped" >
		<thead>
			
			<tr>
				<th bgcolor="#ddd">Shopping Street</th>
				>
			</tr>
		</thead>
		
		<% 
		ArrayList<String> graphData = (ArrayList<String>) session.getAttribute("recommend1");
		

		 Iterator itr = graphData.iterator(); 
		 int count=0;
          while (itr.hasNext()) { 
        	  String location1=(String)itr.next();
